...
const MovieDetails = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-sky-200 py-6 z-50">
        <div className="w-full px-8 md:px-16 lg:px-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {remainingMovies.map((movie) => (
            <div key={movie.title} className="bg-gray-800 rounded-lg overflow-hidden">
